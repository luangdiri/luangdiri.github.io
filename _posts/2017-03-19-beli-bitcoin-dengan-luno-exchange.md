...
Update 12 - 15/1/2024:
- Repost to Juno Blog
- Added list of telegram groups/channels in [Sertai komuniti](#9.-sertai-komuniti)

Update 11 - 1/3/2021:
- Luno ada circuit breaker [About Luno](#0.-about-luno)

Update 10 - 29/12/2020:
- Fixed: How referral works in [Beli Bitcoin](#3.-beli-bitcoin)
- Some more wording fixes

Update 9 - 1/12/2020:
- Updated Luno level table in [Daftar](#2.-daftar)
- Beberapa lagi update dalam post

Update 8 - 24/11/2020:
- removed Luno notice at the top of the page
- [About Luno](#0.-about-luno) includes link to SC registered DAX

Update 7 - 7/6/2020:
- removed 2FA app recommendation, added a new one in [Securing your Bitcoins](#8.-securing-your-bitcoins)
- removed recommended wallets, added some new ones in [Securing your Bitcoins](#8.-securing-your-bitcoins)

Update 6 - 15/5/2020:
- moved to new domain (aemxn.xyz/arkib)
    
Update 5 - 28/3/2020:
- updated [community](#9jointhecommunity) section
    
Update 4 - 14/5/2019:
- added a personal note at the top of the post.

Update 3 - 8/5/2018:
- added more Telegram [group](#9jointhecommunity) community in Malaysia

Update 2 - 3/12/2017:
- added [Nota Penulis](#notapenulis) section

Update 1 - 22/11/2017:
- added information about [Luno Fees](#7lunofees)  
- an update note about Luno interface changes in [About Luno](#0aboutluno)  
- added recommended wallet and 2FA app in [Securing your Bitcoins](#8securingyourbitcoins)
</details>
...
Article ni akan banyak memakai screenshot dari website berbanding app, pasal senang nak screenshot guna desktop. Basically sama je interface website dengan app, jadi boleh faham dengan mudah kot.
...
<a target="_blank" href="https://imgur.com/anjCEoP.png"><img alt="3.1_wallet_details" src="https://imgur.com/anjCEoP.png"/></a>
...
<a target="_blank" href="https://imgur.com/TKebiH7.png"><img alt="4.3_withdrawing" src="https://imgur.com/TKebiH7.png"/></a>
...
Selain Luno, ada juga platform lain untuk main trading. Personally, aku selalu pakai [Poloniex][12] & [Bittrex][35] pasal dia support banyak cryptocurrency dan takde fiat currency, which means aku boleh deposit BTC aku dan straight trade dalam tu.
...
Aku sarankan **sangat** untuk enable kan benda ni dalam apa apa jenis app yang sensitive. Luno boleh enable kan 2FA dalam **Settings** page. Kena pakai ~~[Google Authenticator][17]~~ atau ~~[Authy][38]~~ (**NOT** recommended), [FreeOTP+][42] (recommended, open-source, juga ada di [fdroid][41]) untuk enable kan setting ni.
